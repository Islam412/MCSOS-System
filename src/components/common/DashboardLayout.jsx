    ...
    <div className={`min-h-screen ${theme === 'dark' ? 'dark' : ''}`}>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="flex">
          {/* Sidebar */}
          <aside 
            className={`fixed lg:relative z-30 w-72 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md shadow-2xl flex flex-col transition-transform duration-300 ${
              mobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
            } ${isRTL ? 'right-0 lg:right-auto' : 'left-0 lg:left-auto'}`}
            style={{ [isRTL ? 'right' : 'left']: mobileMenuOpen ? 0 : '-100%' }}
          >
            {/* Logo Area */}
            ...
            <div className="p-4 border-t border-gray-100 dark:border-gray-700 space-y-3">
              ...
              <button className={`flex items-center gap-3 text-red-600 dark:text-red-400 w-full hover:bg-red-50 dark:hover:bg-red-900/30 p-3 rounded-xl transition-colors ${isRTL ? 'flex-row-reverse' : ''}`}>
                <LogOut size={20} />
